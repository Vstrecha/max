...
Utilities for verifying Telegram Mini App init data.
"""
...
def verify_init_data_and_get_user_id(
    ...
    """
    Verify Telegram Mini App init data and extract user information.

    Args:
        init_data_raw: Raw init data from Telegram
...
def extract_telegram_auth_from_header(auth_header: str) -> Optional[str]:
    """
